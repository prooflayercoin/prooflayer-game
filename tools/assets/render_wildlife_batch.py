...
ASSETS = [
    ("animal-boar", "boar.fbx"),
    ("animal-deer", "deer_1.fbx"),
    ("animal-fox", "fox.fbx"),
    ("animal-rabbit", "rabbit.fbx"),
    ("animal-owl", "owl.fbx"),
]
...
def main() -> None:
    ...
    parser.add_argument("--asset-dir", default=".asset-work/wildlife/fbx/unity")
    parser.add_argument("--texture", default=".asset-work/wildlife/texture/wild_animals_map.png")
    parser.add_argument("--raw-dir", default=".asset-work/renders/wildlife")
    parser.add_argument("--out-dir", default="apps/web/public/prooflayer-made/blender-renders/wildlife")
    parser.add_argument("--sheet", default="apps/web/public/prooflayer-made/blender-renders/wildlife-contact-sheet.png")
