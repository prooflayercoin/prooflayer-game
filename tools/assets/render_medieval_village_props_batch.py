...
ASSETS = [
    ("village-wagon", "Prop_Wagon.gltf"),
    ("village-fence", "Prop_WoodenFence_Single.gltf"),
    ("village-vine", "Prop_Vine1.gltf"),
    ("village-shutters", "WindowShutters_Wide_Round_Open.gltf"),
    ("village-door-round", "Door_1_Round.gltf"),
]
...
def main() -> None:
    ...
    parser.add_argument("--asset-dir", default=".asset-work/medieval-village/Medieval Village MegaKit[Standard]/glTF")
    parser.add_argument("--raw-dir", default=".asset-work/renders/medieval-village")
    parser.add_argument("--out-dir", default="apps/web/public/prooflayer-made/blender-renders/medieval-village")
    parser.add_argument("--sheet", default="apps/web/public/prooflayer-made/blender-renders/medieval-village-contact-sheet.png")
