...
ASSETS = [
    ("anvil", "Anvil.gltf"),
    ("axe-bronze", "Axe_Bronze.gltf"),
    ("pickaxe-bronze", "Pickaxe_Bronze.gltf"),
    ("coin-pile", "Coin_Pile.gltf"),
    ("coin-pile-large", "Coin_Pile_2.gltf"),
    ("potion-red", "Potion_1.gltf"),
    ("potion-blue", "Potion_2.gltf"),
    ("scroll-closed", "Scroll_1.gltf"),
    ("scroll-open", "Scroll_2.gltf"),
    ("wood-chest", "Chest_Wood.gltf"),
    ("banner-blue", "Banner_1.gltf"),
    ("banner-red", "Banner_2.gltf"),
    ("market-stall", "Stall_Empty.gltf"),
    ("cart-stall", "Stall_Cart_Empty.gltf"),
    ("wood-shield", "Shield_Wooden.gltf"),
    ("sword-bronze", "Sword_Bronze.gltf"),
]
...
def main() -> None:
    ...
    parser.add_argument("--asset-dir", default=".asset-work/fantasy-props/Exports/glTF")
    parser.add_argument("--raw-dir", default=".asset-work/renders/fantasy-props")
    parser.add_argument("--out-dir", default="apps/web/public/prooflayer-made/blender-renders/fantasy-props")
    parser.add_argument("--sheet", default="apps/web/public/prooflayer-made/blender-renders/fantasy-props-contact-sheet.png")
