...
ASSETS = [
    ("aether-stalk", "Plant_1_Big.gltf"),
    ("starflax", "Plant_7_Big.gltf"),
    ("dawn-bloom", "Flower_3_Group.gltf"),
    ("silverflax", "Flower_4_Group.gltf"),
    ("clover", "Clover_2.gltf"),
    ("flower-bush", "Bush_Common_Flowers.gltf"),
    ("mushroom", "Mushroom_Common.gltf"),
    ("nature-rock", "Rock_Medium_3.gltf"),
]
...
def main() -> None:
    ...
    parser.add_argument("--raw-dir", default=".asset-work/renders/nature")
    parser.add_argument("--out-dir", default="apps/web/public/prooflayer-made/blender-renders/nature")
    parser.add_argument("--sheet", default="apps/web/public/prooflayer-made/blender-renders/nature-contact-sheet.png")
