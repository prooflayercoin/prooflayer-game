...
ASSETS = [
    ("tree-common-a", "CommonTree_1.gltf"),
    ("tree-common-b", "CommonTree_3.gltf"),
    ("tree-common-c", "CommonTree_5.gltf"),
    ("tree-pine-a", "Pine_1.gltf"),
    ("tree-pine-b", "Pine_3.gltf"),
    ("tree-pine-c", "Pine_5.gltf"),
    ("tree-twisted", "TwistedTree_3.gltf"),
    ("tree-dead", "DeadTree_4.gltf"),
]
...
def main() -> None:
    ...
    parser.add_argument("--asset-dir", default=".asset-work/nature/glTF")
    parser.add_argument("--raw-dir", default=".asset-work/renders/nature-trees")
    parser.add_argument("--out-dir", default="apps/web/public/prooflayer-made/blender-renders/nature-trees")
    parser.add_argument("--sheet", default="apps/web/public/prooflayer-made/blender-renders/nature-trees-contact-sheet.png")
